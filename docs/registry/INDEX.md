...
## Master table — Packs (installable GitHub repos)
...
Curated websites, galleries, and live tools. See [`external-resources/README.md`](external-resources/README.md).

| Slug | Name | Tags | Type | Notes |
|------|------|------|------|-------|
| [`cta-gallery`](external-resources/cta-gallery.md) | cta.gallery | `design` | gallery | Curated CTA examples for conversion design |
| [`feynman-is`](external-resources/feynman-is.md) | feynman.is | `ai` `research` `productivity` | live tool | Local AI research agent |
| [`glass3d-dev`](external-resources/glass3d-dev.md) | glass3d.dev | `design` | gallery | 3D-glass visual references |
| [`oneshot-zip`](external-resources/oneshot-zip.md) | oneshot.zip | `design` | gallery | ⚠️ Pending re-verification (live fetch returned 403) |
| [`reui-io`](external-resources/reui-io.md) | reui.io | `design` | component library | 1,003+ shadcn/ui components |
| [`sci-bot`](external-resources/sci-bot.md) | sci-bot.site | `research` `ai` | live SaaS | AI research assistant grounded in Sci-Hub papers (contact via /contact form) |

---

## Specs and conventions (linked references, not repos to install)

These are documentation references, not installable packs. Tracked here so the WIZARD can point to them.
...
- **Cookbook (provider-specific recipes)** — [`tags/cookbook.md`](tags/cookbook.md)
- **Data engineering** — [`tags/data-engineering.md`](tags/data-engineering.md)
- **Design** — [`tags/design.md`](tags/design.md)
- **Ecosystem (broad agentic expansions)** — [`tags/ecosystem.md`](tags/ecosystem.md)
- **Fintech / Trading** — [`tags/fintech.md`](tags/fintech.md)
- **Foundations (canonical references)** — [`tags/foundations.md`](tags/foundations.md)
- **Learning / curricula** — [`tags/learning.md`](tags/learning.md)
- **Machine learning (classic)** — [`tags/ml.md`](tags/ml.md)
- **Productivity** — [`tags/productivity.md`](tags/productivity.md)
- **Research** — [`tags/research.md`](tags/research.md)
- **Security** — [`tags/security.md`](tags/security.md)
- **Stack-specific packs** — [`tags/stack-pack.md`](tags/stack-pack.md)
- **Vision (computer vision)** — [`tags/vision.md`](tags/vision.md)
...
3. Add a row to the master table above.
...
1. Create `external-resources/<slug>.md` using the same one-pager template plus `Type: external resource (not installable)`.
2. Add a row to the **External resources** section above.
3. Add the slug to relevant `tags/<tag>.md` files (under an "External resources" subsection if the tag has one).
