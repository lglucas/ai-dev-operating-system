...
- After `launch-agent` Track A (soft launch).
- User says "ninguém tá usando" / "como divulgar" / "como faço marketing sem dinheiro".
...
- Use `usage-monitor` pra ver quem voltou.

## Output

```
👥 First-100-users tracker

Conversas iniciadas:     142
Sign-ups:                47
Aha-moment completed:    18
Active 7-day:            11

🎯 Próximo gap: do sign-up ao aha-moment (47→18 = 38% drop).
   Hipótese: onboarding muito longo.

🔥 Top feedback (3 menções+):
   - "queria importar de planilha em vez de digitar"
   - "o email de magic link demora 2-3 min"

📅 Esta semana:
   - 20 DMs em LinkedIn (lista preparada).
   - 1 post no nicho X.
   - 3 follow-ups com sign-ups que não voltaram.
```

## Do NOT

- Don't run paid ads in the first 100 users.
- Don't optimize the funnel before 30+ real users.
- Don't ask for retweets / upvotes from family who can't actually use the product.
- Don't pitch in communities where you have no history.
- Don't measure "interest" — measure use.
